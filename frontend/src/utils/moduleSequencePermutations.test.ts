...
const ALL_MODULES = ['screening', 'taste_test', 'purchase_funnel', 'brand_usage', 'brand_pricing_behavior'];
...
function surveyForSequence(sequence: string[]) {
    return {
        ...
        layer2_questions: { sections: [{ questions: [{ id: 'tt_q1' }] }] },
    };
}
...
describe('moduleSequencePermutations', () => {
    it('default 5-module sequence matches registry order', () => {
