...
OVERALL_FEATURES_ITEMS = [
    ("Criteria-Overall-1", "comparison", {
        "module": "comparison",
        "inputs": {
            "set_of_features": "overall_features",
            "ideal": 10,
    ...
    ("overall Averages", "comparison", {
        ...
        "viz_type": "chart", "new_name": "Overall Score", "xmax": 10, "ymin": 1,
...
class TasteTestOverallFeaturesSlide(DynamicSlideConcept, _TasteTestMixin):
    INSTANCE_KEY = "slide_overall_features"
    TEMPLATE_TITLE = "Overall Features"
    ...
    def required_input_keys(cls) -> List[str]:
        return ["comparators", "overall_features", "comparison_purchase_intent"]
    ...
    def process(self, data_store, meta_data, meta_grids, codebook_df, project_inputs: dict, client: Any = None, model: str = None) -> Dict[str, Any]:
        ...
        for vid, _, item_cfg in OVERALL_FEATURES_ITEMS:
    ...
    def populate(
        ...
        self._populate_multi_item(pres, instance_key, payload, OVERALL_FEATURES_ITEMS, self.my_brand, tracker, log)
    ...
    def get_insight_summary(self, instance_key: str, payload: Any) -> str:
        return "Taste Test Overall Features"[:500]
